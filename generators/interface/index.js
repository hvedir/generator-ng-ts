...
var InterfaceGen = BaseGenerator.extend({
  constructor: function () {
    BaseGenerator.apply(this, arguments);
  },
  prompting: BaseGenerator.prototype.prompting,
  normalizeProps: function () {
    this.name = utils.normalizeInterfaceName(this.name, this.determineAppname());
  },
  writing: function () {
    ...
    this.env.run('ng-ts:ns ' + ns).on('ready', function () {
      this.fs.copyTpl(this.templatePath('interface.ts.ejs'), classPath, {
        nsName: ns,
...
exports = module.exports = InterfaceGen;
